...
/* 
 * Definitions for Marvell PPv2 Header Parser
 */
#ifndef _MVPP2_PRS_H
#define _MVPP2_PRS_H
...
/* Parser entry manipulation */
int mvpp2_prs_hw_write(struct mvpp2 *priv, struct mvpp2_prs_entry *pe);

int mvpp2_prs_init_from_hw(struct mvpp2 *priv, struct mvpp2_prs_entry *pe,
			   int tid);

void mvpp2_prs_hw_inv(struct mvpp2 *priv, int index);

void mvpp2_prs_shadow_set(struct mvpp2 *priv, int index, int lu);

void mvpp2_prs_shadow_ri_set(struct mvpp2 *priv, int index, unsigned int ri,
			     unsigned int ri_mask);

void mvpp2_prs_tcam_lu_set(struct mvpp2_prs_entry *pe, unsigned int lu);

void mvpp2_prs_tcam_port_set(struct mvpp2_prs_entry *pe, unsigned int port,
			     bool add);
...
int mvpp2_prs_tcam_ai_get(struct mvpp2_prs_entry *pe);

/* MAC filtering */
int mvpp2_prs_mac_da_accept(struct mvpp2_port *port, const u8 *da, bool add);

int mvpp2_prs_mac_da_accept_list(struct mvpp2_port *port,
