...
/*
 * Definitions for the Marvell PPv2 driver
 */
...
extern const struct ethtool_ops mvpp2_eth_tool_ops;
 ...
 */
void mvpp2_mac_config(struct net_device *dev, unsigned int mode,
...
void mvpp2_rx_pkts_coal_set(struct mvpp2_port *port, struct mvpp2_rx_queue *rxq);
void mvpp2_tx_pkts_coal_set(struct mvpp2_port *port, struct mvpp2_tx_queue *txq);
void mvpp2_rx_time_coal_set(struct mvpp2_port *port, struct mvpp2_rx_queue *rxq);
void mvpp2_tx_time_coal_set(struct mvpp2_port *port);
#endif
